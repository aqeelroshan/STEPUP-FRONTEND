          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                Hotline: <a className='text-white' href="tel:+91 9746033838">+91 9746033838</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <header className="header-upper py-3">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h2>
                <Link className='text-white'>STEP UP</Link>
              </h2>
            </div>
            <div className="col-5">
            ...
            <div className="col-5">
              <div className="header-upper-links justify-content-between">
                <div>
